    ...
    return (
        <SC.JoinContainer>
            ...
            <SC.JoinDiv2>
                <SC.JoinItem>
                    <label>이름</label>
                    <input type="text" name="lastName" placeholder="홍" />
                    <input type="text" name="firstName" placeholder="길동" />
                </SC.JoinItem>
                <SC.JoinItem>
                    <label>닉네임</label>
                    <input type="text" name="nickname" placeholder="dong" />
                </SC.JoinItem>
                ...
                <SC.JoinItem>
                    <label>주소</label>
                    <input type="text" name="zipCode" placeholder="04799" />
                    <div>
                    ...
                    />
                    <input type="text" name="detailAddress" placeholder="49" />
                </SC.JoinItem>
                <SC.JoinItem>
                    <label>프로필 사진</label>
